...
class GUI:
    ...
    def configureButtons(self, window):
        ...
        cellLabel = tkinter.Label(window, text="Cell: - | Sugar: - | Spice: - | Pollution: - | Season: -\nAgent: - | Age: - | Vision: - | Movement: - | Sugar: - | Spice: - | Metabolism: - | Decision Model: - | Diseases: -", font="Roboto 10", justify=tkinter.CENTER)
    ...
    def updateHighlightedCellStats(self):
        ...
        if cell != None:
            ...
            if agent != None:
                ...
                agentStats += f"Diseases: {len(agent.symptomaticDiseases)}"
            else:
                agentStats = "Agent: - | Age: - | Vision: - | Movement: - | Sugar: - | Spice: - | Metabolism: - | Decision Model: - | Diseases: - "
            cellStats += f"\n{agentStats}"
        else:
